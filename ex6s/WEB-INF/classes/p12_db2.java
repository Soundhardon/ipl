...
Integer gp = rs.getInt("gp"); 
Integer wins = rs.getInt("wins"); 
Integer loss = rs.getInt("loss"); 
Integer draw = rs.getInt("draw");
// Display values
out.println("<p> <b>Player ID :</b> " + pid + "<br>"); 
out.println("<b>name : </b>" + name + "<br><hr style='border: 1px solid'><br>");
out.println("<b>gp : </b>" + gp + "<br>"); 
out.println("<b>wins : </b>" + wins + "<br>"); 
out.println("<b>loss : </b>" + loss + "<br>"); 
out.println("<b>draw : </b>" + draw + "<br></p>");
}
